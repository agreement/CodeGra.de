...
project = 'CodeGra.de'
copyright = '2018, CodeGra.de'
author = 'Devin Hillenius'
...
release = '0.23.7 - (GodfriedMetDenBaard)'
...
man_pages = [(master_doc, 'codegrade', 'CodeGra.de Documentation', [author],
              1)]
...
texinfo_documents = [
    (master_doc, 'CodeGrade', 'CodeGra.de Documentation', author, 'CodeGrade',
