...
latex_documents = [
    (master_doc, 'CodeGrade.tex', 'CodeGra.de Documentation',
...
man_pages = [
    (master_doc, 'codegrade', 'CodeGra.de Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'CodeGrade', 'CodeGra.de Documentation',
     author, 'CodeGrade', 'One line description of project.',
     'Miscellaneous'),
]
